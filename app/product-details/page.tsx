...
export default function ProductDetailsPage() {
  ...
  // Static list of primary products (replace with backend data later)
  ...
  // Example product data (replace with actual backend response)
  const product = {
    name: "Super Widget",
    image: "/images/cnc.jpg", // Place your image in public/images/
  ...
  return (
    <div className="min-h-screen flex justify-center items-start p-6 pt-12">
      <div className="bg-gradient-to-b from-yellow-50 via-yellow-100 to-white backdrop-blur-xl rounded-3xl shadow-2xl p-8 max-w-5xl w-full text-black flex flex-col md:flex-row gap-8">
        {/* Left Side: Product Image + Dropdown */}
...
<button  onClick={() => goToCategory("mechanical")}  className="rounded-full bg-gradient-to-r from-yellow-400 to-orange-400 py-2 px-4 font-semibold">View More</button>
          </div>
